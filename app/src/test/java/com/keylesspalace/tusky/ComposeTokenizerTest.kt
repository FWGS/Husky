    ...
    companion object {
        ...
        fun data(): Iterable<Any> {
            return listOf(
                    ...
                    arrayOf(" @ment10n_@l0calhost @ment20n@huskyapp.dev", 21, 42),
                    arrayOf(" @ment10n_@l0calhost @ment20n_@huskyapp.dev", 21, 43),
                    arrayOf(" @ment10n-@l0calhost @ment20n-@huskyapp.dev", 21, 43),
                    arrayOf("mention", 7, 7),
                    arrayOf("ment10n", 7, 7),
                    arrayOf("mentio_", 7, 7),
                    arrayOf("#tusky", 0, 6),
